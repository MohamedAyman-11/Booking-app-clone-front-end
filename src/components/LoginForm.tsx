  ...
  return (
    <Box sx={{
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        {
          LoginFormData.map(({type, id, name, placeholder, label}) => {
            return <Box sx={{width: '100%', mb: '15px'}} key={type}>
      ...
      <Typography sx={{fontSize: '14px', textAlign: 'center'}}>Lost access to your email? <Typography sx={(theme) => ({
